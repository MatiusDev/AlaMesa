...
const Home = () => {
  ...
  const view = () => `
    <section class="mx-auto max-w-7xl px-4 pt-28 pb-10">
      ...
      <div class="mt-16">
        <h2 class="text-xl font-semibold mb-4">Restaurantes destacados del Valle de Aburrá</h2>
        <div class="rounded-[var(--am-radius)] overflow-hidden border border-neutral-200 shadow-soft bg-white">
          <div id="${HOME_MAP_ID}" class="h-[460px] w-full"></div>
        </div>
      </div>
    </section>
  `;
